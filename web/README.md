...
2. In Supabase **SQL Editor**, run migrations in order:
   ...
   - AI Asset Library intake: `npm run assets:import -- --source "C:\path\to\images" --owner-id <teacher-uuid> --collection <slug>` (dry run by default; add `--apply` to upload). See `docs/asset-library/AI_ASSET_LIBRARY_PLAN.md`.
