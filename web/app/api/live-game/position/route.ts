...
export async function POST(request: Request) {
  return withLiveGameServerTiming("live_game_position", async (timer) => {
    try {
      ...
      return accepted ?
        ...
        : NextResponse.json({ error: "Position rejected." }, { status: 409 });
    } catch {
