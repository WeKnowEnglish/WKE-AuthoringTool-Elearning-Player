...
export function PetExerciseResultsScreen({
  tier,
  muted,
  onReturn,
  onPlayAgain,
  ...
  const deltas = EXERCISE_MINIGAME_DELTAS[tier];
  const deltaRows = (
      ...
      <KidPanel className="relative space-y-4 border-kid-ink bg-white/95 p-4">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-3 text-2xl font-extrabold text-kid-ink sm:text-3xl">
            {good ? "Great climb!" : "Keep practicing!"}
          </p>
          <p className="mt-1 text-sm font-semibold text-kid-ink/85">
            {good ?
              "Your pet got a good workout!"
            : "Your pet is a bit tired and discouraged."}
          </p>
        </div>
