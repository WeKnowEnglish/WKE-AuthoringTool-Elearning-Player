...
export function DefinitionMatchPilot() {
      ...
      <div className="mx-auto max-w-5xl space-y-4">
        <header className="rounded-2xl border-2 border-slate-200 bg-white/95 px-4 py-3 shadow-sm">
          ...
          <p className="text-sm font-semibold text-slate-600">
            Standalone reading module — match words to meanings from Activity Bank or the
            sample set.
          </p>
          {notice ? (
        ...
        <DefinitionMatchPlayer activity={toDefinitionMatchPlayable(document)} />
      </div>
    </main>
  );
}
