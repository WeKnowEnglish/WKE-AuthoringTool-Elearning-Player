...
export function GamesFlashcardsPilot() {
  ...
  useEffect(() => {
    ...
    try {
      const next = parseGamesFlashcardsLessonPlayerPack(remote.rawPack);
      ...
      setImportNotice(
        remote.sourceKind === "activity"
          ? `Loaded from My Activity Bank (${cardCount} card${cardCount === 1 ? "" : "s"}).`
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs font-semibold text-kid-ink/70">
              ...
              Studio Quiz, open an Activity Bank link (
              <code className="font-mono">?activity=</code>), or use Play from Studio.
            </p>
            {importNotice && (
