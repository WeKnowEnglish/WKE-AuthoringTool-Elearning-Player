...
export function ReadAndAnswerPilot() {
      ...
      <div className="mx-auto max-w-5xl space-y-4">
        <header className="rounded-2xl border-2 border-slate-200 bg-white/95 px-4 py-3 shadow-sm">
          ...
          <p className="text-sm font-semibold text-slate-600">
            Standalone reading comprehension — passage plus MC from Activity Bank or the
            sample.
          </p>
          {notice ? (
        ...
        <ReadAndAnswerPlayer activity={toReadAndAnswerPlayable(document)} />
      </div>
    </main>
  );
}
