    ...
    return (
      <div className="space-y-3 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-4">
        ...
        <p className="text-sm text-emerald-900">
          You walked through {total} multiple-choice question{total === 1 ? "" : "s"} from this pack.
          Publishing for students comes in a later slice.
        </p>
    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <p className="text-xs font-medium text-neutral-500">
          ...
          {current.mode === "find_lemma" ? " · find-the-word" : ""}
        </p>
        <button
          type="button"
          onClick={onBackToFormats}
