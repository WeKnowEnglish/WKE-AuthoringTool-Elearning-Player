  ...
  units: [
    {
      ...
      sessions: [
        ...
        {
          id: "session-2-find-a-fair-friend",
          order: 2,
          title: "Find a Fair Friend",
          description: "Ask questions, listen for personal details, and introduce a new friend.",
          durationMinutes: 45,
          status: "pilot" as const,
          pilotHref: "/pilots/grade-4-learning-paths/unit-1/session-2",
          studentHref: "/primary/learn/grade-4/unit-1/session-2",
        },
        {
          id: "session-3-find-something-in-common",
          order: 3,
          title: "Find Something in Common",
          description: "Ask follow-up questions, understand yes and no, and discover a shared interest.",
          durationMinutes: 45,
          status: "pilot" as const,
          pilotHref: "/pilots/grade-4-learning-paths/unit-1/session-3",
          studentHref: "/primary/learn/grade-4/unit-1/session-3",
        },
        ...Array.from({ length: 6 }, (_, index) => ({
          id: `unit-1-session-${index + 4}`,
          order: index + 4,
          title: `Session ${index + 4}`,
