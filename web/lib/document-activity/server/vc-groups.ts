...
import type { SessionGroupRef } from "@/lib/activity-runtime/group-adapter";

/** Read VC session groupSet for document launch auto-assign. */
export async function getVcSessionGroups(roomId: string): Promise<SessionGroupRef[]> {
