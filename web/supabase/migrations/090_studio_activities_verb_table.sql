-- Allow verb_table (homework-template family) in My Activity Bank.
...
comment on column public.studio_activities.authoring is
  'Optional Studio authoring document; required for vocabulary_list, explore_hotspots, picture_cloze, and verb_table.';
